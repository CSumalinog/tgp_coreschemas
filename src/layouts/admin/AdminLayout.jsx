...
// ── Matched to ClientLayout ───────────────────────────────────────────────────
const TEXT_SECONDARY = "rgba(53,53,53,0.85)";
const TEXT_ICON      = "rgba(53,53,53,0.70)";
  ...
  return (
    <Box
      ...
      sx={{
        ...
        backgroundColor: WHITE, border: `1px solid ${BORDER}`, borderBottom: "none",
        borderRadius: "12px 12px 0 0", zIndex: 1400,
    ...
    >
      ...
      {row(
        () => { navigate("/admin/profile"); onClose(); },
        <>
          <AccountCircleOutlinedIcon sx={{ fontSize: 15, color: TEXT_ICON }} />
      ...
      {row(
        toggleDark,
        <>
          <DarkModeOutlinedIcon sx={{ fontSize: 15, color: TEXT_ICON }} />
  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", height: "100%", fontFamily: dm, position: "relative", backgroundColor: SIDEBAR_BG }}>
      ...
      <Box sx={{ position: "relative" }}>
        <ProfileDropdown
          open={dropdownOpen} currentUser={currentUser} userProfile={userProfile}
          onClose={() => setDropdownOpen(false)} footerRef={footerRef}
        />
        <Box
          ref={footerRef}
          onClick={() => setDropdownOpen((p) => !p)}
          sx={{
            px: 2, py: 1.5, borderTop: `1px solid ${BORDER}`,
        ...
        <Box sx={{ display: "flex", alignItems: "center", px: 3, height: 60, flexShrink: 0, backgroundColor: WHITE, borderBottom: `1px solid ${BORDER}`, gap: 2 }}>
          {isMobile && (
            <IconButton onClick={() => setMobileOpen(true)} size="small"
              sx={{ color: TEXT_SECONDARY, borderRadius: "8px", p: 0.75, mr: 0.5, "&:hover": { backgroundColor: HOVER_BG, color: TEXT_PRIMARY } }}
            >
