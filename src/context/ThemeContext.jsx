...
function DataGridStyles({ isDark }) {
  ...
  return (
    <GlobalStyles styles={{
      ...
      // ── Shared: any MuiMenuItem anywhere (catches portalled dropdowns) ────
      // Using * selector with high specificity to override MUI defaults
      ...
      // Select / Input values inside filter form
      ...
      // ── Portalled dropdowns (column selector, operator selector) ──────────
      // Target both MuiPopover and MuiMenu portals — use body-level for max specificity
      ...
      // All MenuItem-root inside any portal — belt AND suspenders
      ...
      // ListItemText inside portalled dropdowns
