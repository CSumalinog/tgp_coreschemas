...
// ------------------ MOCK DATA (Declined only) ------------------
const mockDeclinedRequests = [
  {
    id: 1,
  ...
  const columns = [
    ...
    { field: "dateReceived", headerName: "Date Received", flex: 1 },
    {
      ...
      renderCell: (params) => {
        ...
        let color = "#757575";
        if (value === "Declined") color = "#f44336"; // red for declined
  ...
  return (
    ...
    >
      ...
      <Box sx={{ mb: 2 }}>
        ...
        >
          Review declined coverage requests.
        </Typography>
      </Box>
