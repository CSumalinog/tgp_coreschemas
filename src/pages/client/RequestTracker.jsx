      ...
      <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", mb: 2 }}>
        <Box sx={{ minWidth: 0, flex: 1 }}>
          <Box sx={{ display: "flex", alignItems: "center", gap: 0.75 }}>
            ...
            {isMultiDay && (
              <Box sx={{ px: 0.75, py: 0.15, borderRadius: "20px", backgroundColor: isDark ? "#0d1f0d" : "#f0fdf4", border: "1px solid", borderColor: isDark ? "#166534" : "#86efac", flexShrink: 0 }}>
                <Typography sx={{ fontFamily: dm, fontSize: "0.6rem", fontWeight: 700, color: isDark ? "#4ade80" : "#15803d" }}>
                  {request.event_days.length}-day
                </Typography>
              </Box>
            )}
          </Box>
...
function useGridColumns(isDark, onView) {
  return [
    ...
    { field: "submissionDate", headerName: "Submitted", flex: 0.9, renderCell: (p) => <MetaCell>{p.value}</MetaCell> },
    {
      field: "eventDate", headerName: "Event Date", flex: 1.1,
      renderCell: (p) => (
        <Box sx={{ display: "flex", alignItems: "center", height: "100%", gap: 0.75 }}>
          <Typography sx={{ fontFamily: dm, fontSize: "0.8rem", color: "text.secondary", whiteSpace: "nowrap" }}>{p.value}</Typography>
          {p.row.is_multiday && (
      ...
      renderCell: (p) => {
        ...
        return (
          <Box sx={{ display: "flex", alignItems: "center", height: "100%" }}>
            <Box sx={{ display: "flex", alignItems: "center", gap: 0.6, px: 1.25, py: 0.35, borderRadius: "6px", backgroundColor: cfg.bg }}>
              <Box sx={{ width: 5, height: 5, borderRadius: "50%", backgroundColor: cfg.dot, flexShrink: 0 }} />
              <Typography sx={{ fontFamily: dm, fontSize: "0.7rem", fontWeight: 600, color: cfg.color, letterSpacing: "0.04em" }}>{getFriendlyStatus(p.value)}</Typography>
            </Box>
          </Box>
        );
      },
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 1.5, minWidth: 0 }}>
          ...
          <Box sx={{ minWidth: 0 }}>
            <Box sx={{ display: "flex", alignItems: "center", gap: 0.75 }}>
              ...
              {isMultiDay && (
                <Box sx={{ px: 0.9, py: 0.2, borderRadius: "20px", backgroundColor: isDark ? "#0d1f0d" : "#f0fdf4", border: "1px solid", borderColor: isDark ? "#166534" : "#86efac", flexShrink: 0 }}>
                  <Typography sx={{ fontFamily: dm, fontSize: "0.65rem", fontWeight: 600, color: isDark ? "#4ade80" : "#15803d" }}>
                  ...
                  {request.event_days.map((day, idx) => (
                    <Box key={idx} sx={{ display: "flex", alignItems: "center", gap: 1, px: 1, py: 0.5, borderRadius: "8px", border: `1px solid ${border}`, backgroundColor: isDark ? "rgba(255,255,255,0.02)" : "#fafafa" }}>
                      ...
                      {day.from_time && day.to_time ? (
                        <Typography sx={{ fontFamily: dm, fontSize: "0.8rem", color: "text.primary" }}>
