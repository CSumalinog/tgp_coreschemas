      ...
      renderCell: () => (
        <Box sx={{ display: "flex", alignItems: "center", height: "100%" }}>
          <Box sx={{ display: "flex", alignItems: "center", gap: 0.6, px: 1.25, py: 0.35, borderRadius: "6px", backgroundColor: isDark ? "rgba(245,197,43,0.08)" : "#fef9ec" }}>
            ...
            <Typography sx={{ fontFamily: dm, fontSize: "0.68rem", fontWeight: 600, color: "#b45309", letterSpacing: "0.04em" }}>Draft</Typography>
          </Box>
        </Box>
      ),
    },
    ...
    <Box sx={{ p: 3, backgroundColor: "background.default", minHeight: "100%", fontFamily: dm }}>
      ...
      >
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 2.5 }}>
              ...
              <Section label="Event Details" border={border}>
                ...
                <Box sx={{ display: "grid", gridTemplateColumns: "130px 1fr", rowGap: 0.75, columnGap: 1.5, alignItems: "start", mt: 0.75 }}>
                  ...
                  {selectedDraft.details.is_multiday ? (
                    <>
                      <Typography sx={{ fontFamily: dm, fontSize: "0.75rem", color: "text.secondary", pt: 0.3 }}>
                        Coverage Days
                      </Typography>
                        ...
                        {selectedDraft.details.event_days.map((day, idx) => (
                          ...
                          >
                            ...
                            {day.from_time && day.to_time ? (
                              ...
                              <Typography sx={{ fontFamily: dm, fontSize: "0.78rem", color: "text.disabled", fontStyle: "italic" }}>
                                No time set
                              </Typography>
                            )}
                          </Box>
                ...
                {selectedDraft.details.filePath ? (
                  <Box
                    ...
                    sx={{
                      ...
                      cursor: "pointer", px: 1.25, py: 0.6, borderRadius: "7px",
        ...
        <Box sx={{
          ...
          <ActionBtn onClick={handleClose} border={border}>Close</ActionBtn>
          <ActionBtn primary onClick={() => setConfirmSubmitOpen(true)} icon={<SendOutlinedIcon sx={{ fontSize: 13 }} />}>
            Submit Request
          </ActionBtn>
        </Box>
      </Dialog>
      ...
      <ConfirmDialog
        ...
        title="Submit Request" subtitle="This cannot be undone"
      ...
      <ConfirmDialog
        ...
        title="Delete Draft" subtitle="This cannot be recovered"
        itemName={selectedDraft?.eventTitle}
    ...
    >
      ...
      <Box sx={{ px: 3, py: 2.5, display: "flex", flexDirection: "column", gap: 1.25 }}>
        <Box sx={{ px: 1.5, py: 1.25, borderRadius: "8px", border: `1px solid ${border}`, backgroundColor: isDark ? "rgba(255,255,255,0.02)" : "rgba(53,53,53,0.02)" }}>
          <Typography sx={{ fontFamily: dm, fontSize: "0.85rem", fontWeight: 600, color: "text.primary" }}>{itemName}</Typography>
        </Box>
        <Box sx={{ display: "flex", gap: 1, px: 1.5, py: 1.25, borderRadius: "8px", backgroundColor: warningBg, border: `1px solid ${warningBorder}` }}>
          {warningIcon}
          <Typography sx={{ fontFamily: dm, fontSize: "0.76rem", color: warningColor, lineHeight: 1.55 }}>{warning}</Typography>
        </Box>
      </Box>
    ...
    <Box
      ...
      sx={{
        ...
        ...(primary ? {
          ...
          border: `1px solid ${border || BORDER}`, color: "text.secondary",
