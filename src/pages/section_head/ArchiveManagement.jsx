...
export default function ArchiveManagement({ embedded = false }) {
  ...
  }, [fetchArchived, fetchArchivable, userId, mySection]);
    ...
    <Box sx={{ p: embedded ? 0 : { xs: 2, sm: 3 }, fontFamily: dm }}>
      {!embedded && (
        <Box sx={{ mb: 3 }}>
          ...
          <Typography sx={{ fontFamily: dm, fontSize: "0.72rem", color: "text.secondary", mt: 0.3 }}>Archive completed, declined, or cancelled requests in your section.</Typography>
        </Box>
      )}
