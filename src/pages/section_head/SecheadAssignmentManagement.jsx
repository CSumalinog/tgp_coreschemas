  ...
  const loadAll = useCallback(async () => {
    ...
    try {
      ...
      const forAssignRows = forwardedData.filter((req) => {
        ...
        return !(req.coverage_assignments || []).some(
          (a) => a.staffer?.section === mySection,
        );
      });
        ...
        filtered = filtered.filter((r) =>
          (r.coverage_assignments || []).some(
            (a) =>
              ...
              a.staffer?.section === currentUser?.section,
          ),
        );
      }
      return filtered;
...
function AssignedTab({
  ...
  return (
    <DataGrid
      ...
      disableSelectionOnClick
      rowHeight={52}
      initialState={{ pinnedColumns: { left: ["title"] } }}
      getRowClassName={(p) =>
...
function CompletedTab({ rows, highlight, currentUser, isDark, border }) {
  ...
  const columns = [
    ...
    {
      field: "staffers",
      headerName: "Staffers / Time Record",
      flex: 2,
      sortable: false,
      renderCell: (p) => (
        <Box
        ...
        >
                  ...
                  <Box
                    ...
                    sx={{
                      ...
                      backgroundColor: isSelected
                        ...
                        : "transparent",
                      transition: "all 0.15s",
                      "&:hover": { borderColor: "rgba(245,197,43,0.5)" },
                    }}
                  >
                    <Avatar
                      src={url}
                      sx={{
                        ...
                        backgroundColor: isSelected
                          ...
                          : isDark
                            ? "rgba(255,255,255,0.08)"
                            : "rgba(53,53,53,0.08)",
                        color: isSelected ? CHARCOAL : "text.secondary",
                        flexShrink: 0,
                      }}
                    >
          ...
          {selectedStaffers.length > 0 && (
            ...
            >
              ...
              >
                {selectedStaffers.length} staffer
                {selectedStaffers.length > 1 ? "s" : ""} selected
              </Typography>
            </Box>
          )}
        </Box>
