// src/pages/regular_staff/TrashManagement.jsx
...
export default function TrashManagement({ embedded = false }) {
  ...
  const fetchTrashed = useCallback(async () => {
    ...
    const trashedIds = [...trashedMap.keys()].filter((id) => myRequestIds.includes(id));
  ...
  }, [fetchTrashed, userId, myRequestIds]);
    ...
    <Box sx={{ p: embedded ? 0 : { xs: 2, sm: 3 }, fontFamily: dm }}>
      {!embedded && (
        <Box sx={{ mb: 3 }}>
          ...
          <Typography sx={{ fontFamily: dm, fontSize: "0.72rem", color: "text.secondary", mt: 0.3 }}>Restore or permanently delete trashed assignments.</Typography>
        </Box>
      )}
