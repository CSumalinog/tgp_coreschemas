-- Allow assigned staff to trigger request lifecycle status sync via SECURITY DEFINER RPC.
-- This avoids direct staff UPDATEs on coverage_requests, which may be blocked by RLS.
